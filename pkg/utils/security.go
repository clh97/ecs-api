...
// ArgonParams describe the parameters used by Argon2
...
// GenerateFromPassword generates Argon2 hash from password string
...
// ComparePasswordAndHash compares the password with the hash
